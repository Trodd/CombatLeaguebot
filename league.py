    ...
    if panel_channel:
        ...
        if existing:
            ...
            try:
                ...
                embed.add_field(name="✅ Player Signup", value="Choose to join as a **Player** (create or join a team) or as a **League Sub** (fill in when needed).", inline=False)
                ...
                embed.add_field(name="🔍 Find Eligible Subs",value="Ping the top 24 available League Subs that is below or equal too your team rating.",inline=False)
